...
import banner from "../assets/nolimitbanner.png";
  ...
  return (
    <div className="relative size-full" data-name="Coterie_VO_FINAL New11 1">
      ...
      {/* Centered content overlay container */}
        ...
        <div className="absolute content-stretch flex flex-col gap-[32px] items-start left-[48px] top-[30%] w-[36.25%] max-w-[464px] z-10">
          <Frame1616 />
        </div>
        ...
        <div className="relative w-full max-w-[1280px] h-full">
          ...
          <div className="absolute content-stretch flex gap-[12px] items-center left-[calc(68.33%+48.33px)] top-[2px] z-10">
            <div className="content-stretch flex items-center justify-center p-[8px] relative shrink-0">
              <p className="font-['Helvetica:Bold',sans-serif] leading-none not-italic relative shrink-0 text-[#f1e9da] text-[14px] tracking-[2.8px] uppercase">our beliefs</p>
            </div>
            <div className="content-stretch flex items-center justify-center p-[8px] relative shrink-0">
            ...
            <div className="content-stretch flex items-center justify-center p-[8px] relative shrink-0">
              <p className="font-['Helvetica:Bold',sans-serif] leading-none not-italic relative shrink-0 text-[#f1e9da] text-[14px] tracking-[2.8px] uppercase">contact us</p>
            </div>
          </div>
        </div>
      </div>
